...
namespace PresupuestitoBack.Repositories
{
    public class SalaryRepository : Repository<Salary>, ISalaryRepository
    {
        ...
        public override async Task<Salary> Insert(Salary salary)
        {
            var result = await context.Salaries.AddAsync(salary);
            await context.SaveChangesAsync(); return result.Entity;
        }
        ...
        public override async Task<Salary> GetById(int id)
        {
            ...
            .Where(o => o.Status == true && o.SalaryId == id)
            .FirstAsync();
        }
